# Case: The color-coded clothing system
...
## Passage 2: Street scene — the social enumeration

**Source:** Margaret Atwood, *The Handmaid's Tale*, PDF pp. 32–33.

**Micro-quote:**  
> "These women are not divided into functions"
...
**Contextual paraphrase:**  
Walking through town, Offred observes and classifies the women she sees by dress color: red (Handmaids), dull green (Marthas), red/blue/green stripes (Econowives, wives of poorer men), black (widows). She explains that Econowives are not divided into functions — they must do everything — and notes that Wives appear only in cars, not on sidewalks.
...
## Passage 3: Domestic tableau — the code as visual inventory

**Source:** Margaret Atwood, *The Handmaid's Tale*, PDF p. 89.

**Micro-quote:**  
> "as if taking inventory"

**Working passage:**  
> "The Commander has on his black uniform, in which he looks like a museum guard. [...] He looks us over as if taking inventory. One kneeling woman in red, one seated woman in blue, two in green, standing, a solitary man, thin-faced, in the background. He manages to appear puzzled, as if he can't quite remember how we all got in here. As if we are something he inherited, like a Victorian pump organ, and he hasn't figured out what to do with us. What we are worth."
...
- ModelReader (at two levels)

Optional concepts:

- Encyclopedia (extra-textual historical knowledge activated by the Historical Notes)
- Frame (the pseudo-academic conference frame; the "uniform/institutional dress" frame)
- AlternativeInterpretation (for the hedged P.O.W. attribution, if not modeled as licensed)
...
At the second Model Reader level (after the Historical Notes), the chromatic code is reinterpreted as a designed artifact of the regime's founders, historically synthesized from earlier institutions of control (reported origin in WWII P.O.W. uniforms — status: conjecture within the fiction, to be modeled with its hedged evidential status).

Possible alternative interpretation:

Beyond its classificatory function, red carries a symbolic value that the text itself makes explicit ("the colour of blood, which defines us"): the Model Reader may read the chromatic code not only as a social taxonomy but as a symbolic marking of the Handmaids' reproductive function. This reading is compatible with the code interpretation, is activated by the narrator's own commentary rather than by extra-textual knowledge, and could be modeled as an alternative interpretive path.
